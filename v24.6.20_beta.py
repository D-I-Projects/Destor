...
def add_plugin():  
    selected_option = radio_var.get()
    if selected_option == 1:
        initial_dir = os.path.join(directory,"Server_1", "plugins")
        file_path = filedialog.askopenfilename(initialdir=initial_dir, filetypes=[("Jar files", "*.jar")])
        ...
        initial_dir = os.path.join(directory,"Server_2", "plugins")
        file_path = filedialog.askopenfilename(initialdir=initial_dir, filetypes=[("Jar files", "*.jar")])
        if file_path and os.path.isfile(file_path):
            plugins_folder = os.path.join(initial_dir)
            if not os.path.exists(plugins_folder):
        ...
        initial_dir = os.path.join(directory,"Server_3", "plugins")
        file_path = filedialog.askopenfilename(initialdir=initial_dir, filetypes=[("Jar files", "*.jar")])
        if file_path and os.path.isfile(file_path):
            plugins_folder = os.path.join(initial_dir)
            if not os.path.exists(plugins_folder):
        ...
        initial_dir = os.path.join(directory,"Server_4", "plugins")
        file_path = filedialog.askopenfilename(initialdir=initial_dir, filetypes=[("Jar files", "*.jar")])
        if file_path and os.path.isfile(file_path):
            plugins_folder = os.path.join(initial_dir)
            if not os.path.exists(plugins_folder):
        ...
        initial_dir = os.path.join(directory,"Server_5", "plugins")
        file_path = filedialog.askopenfilename(initialdir=initial_dir, filetypes=[("Jar files", "*.jar")])
        if file_path and os.path.isfile(file_path):
            plugins_folder = os.path.join(initial_dir)
            if not os.path.exists(plugins_folder):
...
def plugins_page():
    ...
    if selected_option == 1:
        global listbox
        plugins_folder_path = os.path.join(directory, "Server_1", "plugins")
